...
export default function UploadStatisticExcel(props: Props) {
    ...
    const handleUpload = async () => {
        ...
        let url = process.env.NEXT_PUBLIC_API_URL + "/api/importReport";
        ...
        let itemErr: String[] = [];
        let itemTemp : StatisticItem[] = response.map((item: any) => {
            if (!item.product) {
            ...
            let detail: StatisticItem = {
                id: uniqueCode++,
                day: date.toISOString(),
                licensePlate: item.licensePlate,
                trailer: item.trailersLicensePlate,
                ticket: item.number,
